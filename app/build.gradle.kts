...
android {
    namespace = "io.github.vagrant326.atvh4"
    compileSdk = 35

    defaultConfig {
        applicationId = "io.github.vagrant326.atvh4"
        minSdk = 23
        targetSdk = 35
    ...
    productFlavors {
        create("prod") {
            ...
            buildConfigField("String", "RELEASE_ASSET", "\"atv-h4.apk\"")
        }
        create("dev") {
            dimension = "channel"
            ...
            buildConfigField("String", "RELEASE_ASSET", "\"atv-h4-dev.apk\"")
        }
    }
